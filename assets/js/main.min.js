$(document).ready(function () {
  ...
  if (window.innerWidth > 1024) {
    ...
    document.querySelector(".should-scroll").classList.remove("should-scroll");
  }
  ...
  console.log("Chiều cao của cửa sổ là: " + windowHeight + " pixels");

  setTimeout(() => {
    if (!isMobileLayout) {
      itemAddScrolls = document.querySelectorAll(".stack-item .should-scroll");

      itemAddScrolls.forEach((element) => {
        element;
      });

      $(".stack-item .should-scroll").each(function (index) {
            ...
            whileScrolling: function () {
              ...
              $(this)
                ...
                .each(function () {
                  ...
                  targetTop = elementTop - 700;
                  if (-scrollTop > targetTop) {
                    // Phần tử này đang hiển thị

                    $(this).addClass("aos-animate");
                  }
                });

              // if ($scrollbar.scrollTop() + $scrollbar.innerHeight() >= $scrollbar[0].scrollHeight) {
              //   console.log("Đã cuộn đến cuối cùng");
              //   // Thực hiện hành động khi cuộn đến cuối cùng
              // }

              // if (this.mcs.topPct >= 100 || this.mcs.topPct == 0) {
              //   canScroll = true;
              // } else {
              //   canScroll = false;
              // }
  ...
  btnPlays.forEach((element) => {
    element.addEventListener("click", () => {
      ...
      setTimeout(() => {
        btnPlay = document.querySelector(".icon_blockvideo");
        if (btnPlay) {
          btnPlay.click();
        }
      }, 1000);
